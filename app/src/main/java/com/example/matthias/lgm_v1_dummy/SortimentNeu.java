...
public class SortimentNeu extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.option_bestellung_add) {
            ...
            boolean bla = dataBaseHelper.addSortiment(String.valueOf(editText.getText()), cursor.getInt(0));
            if(bla){
                Toast.makeText(SortimentNeu.this, "Erfolgreich angelget", Toast.LENGTH_SHORT).show();
            }else {
                Toast.makeText(SortimentNeu.this, "Fehler beim anglegen", Toast.LENGTH_SHORT).show();
            }
            finish();
        }
