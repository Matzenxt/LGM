...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_Produkte) {
            startActivity(new Intent(getApplicationContext(), ProduktListe.class));
        } else if (id == R.id.nav_Auftraege) {
            startActivity(new Intent(getApplicationContext(), Auftraege_Liste.class));
        } else if (id == R.id.nav_Verkaeufer) {
            startActivity(new Intent(getApplicationContext(), verkaeuferliste.class));
        } else if (id == R.id.nav_Sortiment) {
            startActivity(new Intent(getApplicationContext(), SortimentListe.class));
        }
